...
product = [
    {
        'id': 0,
        'image': '/mydish/static/css/images/cakes/cake1.2.jpg',
        'title': 'Carrot Cheese Cake',
        'price': 7.00,
    },
    {
        'id': 1,
        'image': '/mydish/static/css/images/cakes/cake2.2.jpg',
        'title': 'Cheesecake',
        'price': 5.00,
    },
    {
        'id': 2,
        'image': '/mydish/static/css/images/cakes/cake3.2.jpg',
        'title': 'Black Forest',
        'price': 7.00,
    },
    {
        'id': 3,
        'image': '/mydish/static/css/images/cakes/cake4.2.jpg',
        'title': 'Red Velvet Cake',
        'price': 7.00,
    },
    {
        'id': 4,
        'image': '/mydish/static/css/images/cakes/cake5.2.jpg',
        'title': 'Coffee Cake',
        'price': 6.00,
    }
]
...
product = [
    {
        'id': 0,
        'image': '/mydish/static/css/images/cookies/cookies1.2.jpg',
        'title': 'Butter Cookies',
        'price': 10.00,
    },
    {
        'id': 1,
        'image': '/mydish/static/css/images/cookies/cookies2.2.jpg',
        'title': 'White Chocolate Macadamia Nut',
        'price': 14.00,
    },
    {
        'id': 2,
        'image': '/mydish/static/css/images/cookies/cookies3.2.jpg',
        'title': 'Chocolate Chip Cookies',
        'price': 13.00,
    },
    {
        'id': 3,
        'image': '/mydish/static/css/images/cookies/cookies4.2.jpg',
        'title': 'Extra Chocolate Chip Cookies',
        'price': 16.00,
    },
    {
        'id': 4,
        'image': '/mydish/static/css/images/cookies/cookies5.2.jpg',
...
product = [
    {
        'id': 0,
        'image': '/mydish/static/css/images/popcorns/popcorn1.2.jpg',
        'title': 'Butter Popcorn',
        'price': 12.00,
    },
    {
        'id': 1,
        'image': '/mydish/static/css/images/popcorns/popcorn2.2.jpg',
    ...
    {
        'id': 3,
        'image': '/mydish/static/css/images/popcorns/popcorn3.2.jpg',
        'title': 'Marshmallow Popcorn',
        'price': 13.00,
    },
    {
        'id': 4,
        'image': '/mydish/static/css/images/popcorns/popcorn4.2.jpg',
...
products = [
        {
            'id': 0,
            'image': '/mydish/static/css/images/pies/pie1.2.jpg',
            'title': 'Blueberry Pie',
            'price': 5.00,
        },
        {
            'id': 1,
            'image': '/mydish/static/css/images/pies/pie2.2.jpg',
            'title': 'Apple Pie',
            'price': 4.00,
        },
        {
            'id': 2,
            'image': '/mydish/static/css/images/pies/pie3.2.jpg',
            'title': 'Pumpkin Pie',
            'price': 6.00,
        },
        {
            'id': 3,
            'image': '/mydish/static/css/images/pies/pie4.2.jpg',
            'title': 'Strawberry Pie',
            'price': 5.00,
        },
        {
            'id': 4,
            'image': '/mydish/static/css/images/pies/pie5.2.jpg',
            'title': 'Peach Pie',
            'price': 8.00,
        }
    ]
...
def addtocart(request):
    return render(request, 'mydish/addtocart.html', {'product': product})
...
def finalized_sidedish(request):
    carts = FinalizedCart.objects.all()
    return render(request, 'finalized_sidedish.html', {'carts': carts})

# Add other view functions

def sidedish(request):
    # Example implementation for sidedish view
    return JsonResponse({"message": "Sidedish"})

def save_data(request):
    # Logic to save data
    return JsonResponse({"message": "save_data"})
