...
class Environ(object):
    ...
    >>>
    >>> def f():
    ...     # Get x from an upper level on the stack.
    ...     @ctx.function
    ...     def x(ctx):
    ...
    def inherit(self, name):
        """
        Similar to del ctx[name], except that the value at this context is simply discarded (though returned) instead of being left with a marker to consider it deleted.
